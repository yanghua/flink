...
public class MetadataValidator implements DescriptorValidator {
	...
	public static String METADATA_PROPERTY_VERSION = "metadata.property-version";
	public static String METADATA_COMMENT = "metadata.comment";
	public static String METADATA_CREATION_TIME = "metadata.creation-time";
	public static String METADATA_LAST_ACCESS_TIME = "metadata.last-access-time";
